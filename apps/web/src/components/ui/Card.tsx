...
export function Card({
  children,
  classes,
  buttonConfig = { useDefault: true, alignment: "right" },
  footer,
}: CardProps) {
  return (
        ...
        {buttonConfig && (
          ...
          >
            {buttonConfig.useDefault ? (
              <>
                <Button classes="mr-4 bg-gray-300 text-gray-700 hover:bg-gray-400">
                  Exit
                </Button>
              ...
              buttonConfig.customButtons.map((button, index) => (
